...
By default, `main()` constructs a task asking the agent to create `pi_approx.py` that approximates $\pi$ using the Leibniz series until the absolute error is below 1e-5, then prints the number of iterations required.
