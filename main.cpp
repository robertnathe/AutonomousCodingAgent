...
int main() {
    ...
    try {
        ...
        if(choice == "2") {
            ...
            if(task.empty()) {
                task = R"(Task 11. Monte Carlo Integration
                Create a c++ program monte_carlo.cpp to estimate ∫sin(x)dx from 0 to π using 1,000,000 
                random points. Compare estimate to analytical value 2. Print absolute error.)";                
            }
